                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="semester" name="semester" class="form-select" required>
                                ...
                                <option value="1" {{ old('semester') == '1' ? 'selected' : '' }}>Semester Ganjil (1)</option>
                                <option value="2" {{ old('semester') == '2' ? 'selected' : '' }}>Semester Genap (2)</option>
                                <option value="3" {{ old('semester') == '3' ? 'selected' : '' }}>Semester Ganjil (3)</option>
                                <option value="4" {{ old('semester') == '4' ? 'selected' : '' }}>Semester Genap (4)</option>
                                <option value="6" {{ old('semester') == '6' ? 'selected' : '' }}>Semester Genap (6)</option>
                            </select>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            try {
                ...
                function initializeMataKuliahDropdown() {
                    ...
                    const oldSemester = '{{ old("semester") }}';
                    const oldKelas = '{{ old("kelas") }}';
                    const oldMatakuliah = '{{ old("matakuliah") }}';

                    if (oldSemester && oldKelas) {
                        semesterSelect.value = oldSemester;
                        updateKelasOptions();
                        kelasSelect.value = oldKelas;
                        updateMataKuliahOptions();
                        
                        // Set mata kuliah after options are loaded
                        setTimeout(() => {
                            if (oldMatakuliah) {
                ...
                function updateKelasOptions() {
                    ...
                    // Reset kelas dropdown (selalu reset di tambahJSA)
